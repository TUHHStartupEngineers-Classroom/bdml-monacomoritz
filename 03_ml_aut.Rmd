...
employee_attrition_tbl <- read_csv("~/Documents/GitHub/data/Business Decisions with Machine Learning/datasets-1067-1925-WA_Fn-UseC_-HR-Employee-Attrition.txt")


path_data_definitions <- "~/Documents/GitHub/data/Business Decisions with Machine Learning/data_definitions.xlsx"
...
product_data <- read_csv("~/Documents/GitHub/data/Business Decisions with Machine Learning/product_backorders.csv")
...
```{r}
Sys.setenv(JAVA_HOME="/Library/Java/JavaVirtualMachines/jdk-17.0.3.1.jdk/Contents/Home")
...
#deeplearning_grid_01_model_8
#h2o.getModel("~/Documents/GitHub/bdml-monacomoritz/04_perf_meas_model/deeplearning_grid_01_model_8") %>% h2o.saveModel(path = "04_Modeling/h20_models/")
#h2o.getModel("DeepLearning_grid__1_AutoML_20200820_190823_model_1") %>% h2o.saveModel(path = "04_Modeling/h20_models/")
...
```{r}
best_model %>% h2o.saveModel(path = "StackedEnsemble_AllModels_AutoML_20220518_202714")
